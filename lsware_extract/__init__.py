...
def _real_main(argv=None):
    ...
    parser.add_argument('-type', required=False) #, help="select type [all, part, partial]", required=True, choices=['all', 'part', 'partial'])
    parser.add_argument('-in', dest='content', required=False) #, help="input the path of the content file", required=True)
    ...
    parser.add_argument('-out', required=False) #, help="input the path of the dna file")
